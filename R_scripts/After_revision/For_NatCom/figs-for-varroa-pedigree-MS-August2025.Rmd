...
### Figure S2: Variant Quality Distribution 
...
cat("\n**Figure S2.** Distribution of variant quality scores across sites that passed initial filtering (depth ≥16, ≤40; maximum 50% missing data). The red dashed line indicates the quality threshold (15000) used for final filtering. %.1f%% of variants have quality scores above this threshold. Higher quality scores indicate greater confidence in variant calls.", pct_above_threshold)
```

### Genotype Classification Thresholds, VAF and QAF

Based on empirical distribution analysis (see the following figures S7-9), we
...
## Figure S3-5 : Picking the thresholds for site quality: Distribution of VAF and QAF in F2 Offspring of homozygous parents

### Figure S3, Quality Allele Frequency (QAF) and Variant Allele Frequency (VAF) in F2 females of AA parents. 
...
### Figure S4, Quality Allele Frequency (QAF) and Variant Allele Frequency (VAF) in F2 females of BB parents. 
...
### Figure S5, Quality Allele Frequency (QAF) and Variant Allele Frequency (VAF) in F2 females of AA and AB parents. 

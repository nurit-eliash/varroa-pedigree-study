...
This document contains supplementary figures and analyses for our study on the mode of genetic inheritance in *Varroa destructor*. It should be read in conjunction with the detailed methodology presented in [Site Quality Analysis](site_quality_exploration.html).
...
## Data Availability
- Raw sequencing data: [BioProject PRJNA794941](https://www.ncbi.nlm.nih.gov/bioproject/PRJNA794941/)
- Analysis code: [GitHub Repository](https://github.com/nurit-eliash/varroa-pedigree-study/)
- Filtered datasets: Available upon request

# Prerequisites and Setup

## Project Overview
This analysis is part of a comprehensive study investigating the genetic inheritance patterns in *Varroa destructor* mites. We analyzed genomic data from 223 mite samples across 30 families, collected from three *Apis mellifera* colonies. Each family consists of three generations:
...
Based on empirical distribution analysis (see Figures 1-2), we established the following thresholds:
...
*The following code sections are preserved for future analysis but are not visible in the HTML output.*

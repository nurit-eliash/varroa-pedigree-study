...
Create the filtered sites *"filtered_sites"* dataset that will be used in the final supp Rmd file, and save as csv    
...
Summarized statistics for the filtered data, and Save the f2_homo_parents data for use in the next Rmd file and create the QAF and VAF plots for the supp info of the MS
```{r summary-stats-and-plots}

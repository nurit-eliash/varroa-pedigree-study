...
```{r libraries, echo=FALSE, eval=TRUE, warning=FALSE, message=FALSE, cache=TRUE}
library(vcfR)
library(tidyverse)
library(ggokabeito) 
library(RcppRoll)
...
```{r load-data, echo=FALSE, eval=TRUE, warning=FALSE, message=FALSE, cache=TRUE}
...
save the filtered sites,to be used in the pulled data analysis

...
Extract genotypes for each site and individual. The metadata for all samples can be found in [here](https://github.com/nurit-eliash/varroa-linkage-map/blob/main/data/Table%20S1.%20Biosamples%20detalis.xlsx).
...
![](/Users/nuriteliash/Documents/GitHub/varroa-linkage-map/pictures/Maternal_genotype_distribution.jpg)

...
The individual ID name nomenclature is composed of 3 parts, separated by an underscore: (*_*).  For example
The first part is the family ID, 
```{r}
...
From the 223 individuals of 30 families, we keep adult males and females in F1 and F2 generations.  

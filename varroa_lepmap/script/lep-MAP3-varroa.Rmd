...
## are all markers belonging to one LG locate on the same chromosome?  
15/7/2022, I can check this using any of the three data, as the the allocation of the markers to linkage groups is the same.
```{r warning=FALSE,message=FALSE}
setwd("/Users/nuriteliash/Documents/GitHub/varroa-linkage-map/varroa_lepmap/data/Q40BIALLDP16HDP40mis.5Chr7/removed_34mark/Recom_male_fem")

map_files = list.files(path ="/Users/nuriteliash/Documents/GitHub/varroa-linkage-map/varroa_lepmap/data/Q40BIALLDP16HDP40mis.5Chr7/removed_34mark/Recom_male_fem", pattern = "\\mapped$")
...
```{r echo=FALSE, warning=FALSE,message=FALSE}
setwd("/Users/nuriteliash/Documents/GitHub/varroa-linkage-map/varroa_lepmap/data/Q40BIALLDP16HDP40mis.5Chr7/removed_34mark/0_male")

# get a vector of the input files ('order_.mapped' files in the directory)
map_files = list.files(path ="/Users/nuriteliash/Documents/GitHub/varroa-linkage-map/varroa_lepmap/data/Q40BIALLDP16HDP40mis.5Chr7/removed_34mark/0_male", pattern = "\\mapped$")
...
```{r echo=FALSE, warning=FALSE,message=FALSE}
setwd("/Users/nuriteliash/Documents/GitHub/varroa-linkage-map/varroa_lepmap/data/Q40BIALLDP16HDP40mis.5Chr7/removed_34mark/0_fem")

# get a vector of the input files ('order_.mapped' files in the directory)
map_files = list.files(path ="/Users/nuriteliash/Documents/GitHub/varroa-linkage-map/varroa_lepmap/data/Q40BIALLDP16HDP40mis.5Chr7/removed_34mark/0_fem", pattern = "\\mapped$")

...
map_files = list.files(path ="/Users/nuriteliash/Documents/GitHub/varroa-linkage-map/varroa_lepmap/data/Q40BIALLDP16HDP40mis.5Chr7.infoSites/Q40BIALLDP16HDP40mis.5Chr7.Sites_11_01/Recom_male_fem", pattern = "\\mapped$")
...
# get a vector of the input files ('order_.mapped' files in the directory)
map_files = list.files(path ="/Users/nuriteliash/Documents/GitHub/varroa-linkage-map/varroa_lepmap/data/Q40BIALLDP16HDP40mis.5Chr7.infoSites/Q40BIALLDP16HDP40mis.5Chr7.Sites_11_01/0_male", pattern = "\\mapped$")
...
```{r echo=FALSE, warning=FALSE,message=FALSE}
setwd("/Users/nuriteliash/Documents/GitHub/varroa-linkage-map/varroa_lepmap/data/Q40BIALLDP16HDP40mis.5Chr7.infoSites/Q40BIALLDP16HDP40mis.5Chr7.Sites_00_01/filteredSites611/0_fem")

# get a vector of the input files ('order_.mapped' files in the directory)
map_files = list.files(path ="/Users/nuriteliash/Documents/GitHub/varroa-linkage-map/varroa_lepmap/data/Q40BIALLDP16HDP40mis.5Chr7.infoSites/Q40BIALLDP16HDP40mis.5Chr7.Sites_00_01/filteredSites611/0_fem", pattern = "\\mapped$")
...
map_files = list.files(path ="/Users/nuriteliash/Documents/GitHub/varroa-linkage-map/varroa_lepmap/data/Q40BIALLDP16HDP40mis.5Chr7.infoSites/Q40BIALLDP16HDP40mis.5Chr7.Sites_00_01/Recom_male_fem/", pattern = "\\mapped$")
...
```{r warning=FALSE,message=FALSE}
setwd("/Users/nuriteliash/Documents/GitHub/linkage-map-BIGdata/lepmapBigData/Q40BIALLDP16HDP40maf.2mis.65Chr7/map3_3/Recom_male_fem")

map_files = list.files(path ="/Users/nuriteliash/Documents/GitHub/linkage-map-BIGdata/lepmapBigData/Q40BIALLDP16HDP40maf.2mis.65Chr7/map3_3/Recom_male_fem", pattern = "\\mapped$")
...
27/7/2022
## changing marker's LG to the main LG in the chromosome
## load data
```{r}
...
map <- read_delim("/Users/nuriteliash/Documents/GitHub/linkage-map-BIGdata/lepmapBigData/Q40BIALLDP16HDP40mis.5Chr7/maf0.2/map3_4_js2/map3_4_js2.txt",col_names = c("LG", "XsqrLG1", "LG2", "XsqrLG2", "LG3", "XsqrLG3", "LG4", "XsqrLG4","LG5", "XsqrLG5"), skip = 1) 
map <- map %>% mutate(order = c(1:length(LG)))
```

```{r}
# state the main LG in each chromosome:
LGs <- tibble(CHR = c("NW_019211454.1", "NW_019211455.1","NW_019211456.1","NW_019211457.1", "NW_019211458.1","NW_019211459.1", "NW_019211460.1"), LG_new = as.character(c(13,16,2,6,3,1,11)))
...
df <- left_join(LGs, snp, by ="CHR") %>%left_join(keep, by="order") %>% view()
  na.omit() %>% dplyr::select("#java NEW_LGs JoinSingles2 map=map3_4.txt data=data_f_maf0.2.call iterate=1 lodLimit=2"=LG_new)
...
i run the orderMarkers for the 7 LG-chromosomes. 
/Users/nuriteliash/Documents/GitHub/linkage-map-BIGdata/lepmapBigData/Q40BIALLDP16HDP40mis.5Chr7/maf0.2/map3_4_js2_new

29/7/2022
lepmap with reduced VCF file . filtered for 0.65 missing data
/Users/nuriteliash/Documents/GitHub/linkage-map-BIGdata/lepmapBigData/Q40BIALLDP16HDP40maf.2mis.65Chr7

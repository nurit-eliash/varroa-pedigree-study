...
load data of the markers position, based on recombination frequency (done by Lep-MAP)
code in  ~/Documents/GitHub/varroa-linkage-map/varroa_lepmap/script/lep-MAP3-varroa.Rmd
```{r}
sites_recom = read.csv(file = "/Users/nuriteliash/Documents/GitHub/varroa-linkage-map/varroa_lepmap/results/sites_recom.csv", header = TRUE, sep = " ")

...
```{r}
setwd("/Users/nuriteliash/Documents/GitHub/linkage-map/linkage-map-git")
```

### Heterozygosity and inbreeding coefficient per individual
```{r}
ind_het <- read_delim("/Users/nuriteliash/Documents/GitHub/linkage-map/linkage-map-git/data/site_filter_malesHet.2/malesHet.2Q20BIALLDP5mis.5Chr7.het", delim = "\t",
...
#### for all individuals
```{r}
site_hwe <- read_delim("/Users/nuriteliash/Documents/GitHub/linkage-map/linkage-map-git/data/site_filter_malesHet.2/malesHet.2Q20BIALLDP5mis.5Chr7.hwe", delim = "\t", col_names = c("CHR","POS", "OBS(HOM1/HET/HOM2)", "E(HOM1/HET/HOM2)", "ChiSq_HWE", "P_HWE", "P_HET_DEFICIT", "P_HET_EXCESS"), skip = 1)
...
#### for males 
```{r}
site_hwe_males <- read_delim("/Users/nuriteliash/Documents/GitHub/linkage-map/linkage-map-git/data/site_filter_malesHet.2/site_filter_malesHet.2males/malesHet.2Q20BIALLDP5mis.5Chr7males.hwe", delim = "\t", col_names = c("CHR","POS", "OBS(HOM1/HET/HOM2)", "E(HOM1/HET/HOM2)", "ChiSq_HWE", "P_HWE", "P_HET_DEFICIT", "P_HET_EXCESS"), skip = 1)
...
#### for females 
```{r}
site_hwe_females <- read_delim("/Users/nuriteliash/Documents/GitHub/linkage-map/linkage-map-git/data/site_filter_malesHet.2/site_filter_malesHet.2fem/malesHet.2Q20BIALLDP5mis.5Chr7Females.hwe", delim = "\t", col_names = c("CHR","POS", "OBS(HOM1/HET/HOM2)", "E(HOM1/HET/HOM2)", "ChiSq_HWE", "P_HWE", "P_HET_DEFICIT", "P_HET_EXCESS"), skip = 1)
...
#### site quality
```{r}
# (1) 88972 sites of all 203 samples 
var_qual <- read_delim("/Users/nuriteliash/Documents/GitHub/linkage-map/linkage-map-git/data/site_filter_malesHet.2/malesHet.2Q20BIALLDP5mis.5Chr7.lqual", delim = "\t",col_names = c("chr", "pos", "qual"), skip = 1)
...
# (2) 88972 sites of 84 females
var_qual_f <- read_delim("/Users/nuriteliash/Documents/GitHub/linkage-map/linkage-map-git/data/site_filter_malesHet.2/site_filter_malesHet.2fem/malesHet.2Q20BIALLDP5mis.5Chr7Females.lqual", delim = "\t",col_names = c("chr", "pos", "qual"), skip = 1)
...
# (3) 88972 sites of 51 males
var_qual_m <- read_delim("/Users/nuriteliash/Documents/GitHub/linkage-map/linkage-map-git/data/site_filter_malesHet.2/site_filter_malesHet.2males/malesHet.2Q20BIALLDP5mis.5Chr7males.lqual", delim = "\t",col_names = c("chr", "pos", "qual"), skip = 1)
...
```{r}
# 1. 88972 sites of all 203 samples
var_depth <- read_delim("/Users/nuriteliash/Documents/GitHub/linkage-map/linkage-map-git/data/site_filter_malesHet.2/malesHet.2Q20BIALLDP5mis.5Chr7.ldepth.mean", delim = "\t",
...
# 2. 88972 sites of 84 females
var_depth_f <- read_delim("/Users/nuriteliash/Documents/GitHub/linkage-map/linkage-map-git/data/site_filter_malesHet.2/site_filter_malesHet.2fem/malesHet.2Q20BIALLDP5mis.5Chr7Females.ldepth.mean", delim = "\t",
           col_names = c("chr", "pos", "mean_depth", "var_depth"), skip = 1)
...
# 3. 88972 sites of 51 males
var_depth_m <- read_delim("/Users/nuriteliash/Documents/GitHub/linkage-map/linkage-map-git/data/site_filter_malesHet.2/site_filter_malesHet.2males/malesHet.2Q20BIALLDP5mis.5Chr7males.ldepth.mean", delim = "\t",
           col_names = c("chr", "pos", "mean_depth", "var_depth"), skip = 1)
...
```{r}
# 1. 88972 sites of all 203 samples
var_miss <- read_delim("/Users/nuriteliash/Documents/GitHub/linkage-map/linkage-map-git/data/site_filter_malesHet.2/malesHet.2Q20BIALLDP5mis.5Chr7.lmiss", delim = "\t",
...
# 2. 365,173 sites of 84 females
var_miss_f <- read_delim("/Users/nuriteliash/Documents/GitHub/linkage-map/linkage-map-git/data/site_filter_malesHet.2/site_filter_malesHet.2fem/malesHet.2Q20BIALLDP5mis.5Chr7Females.lmiss", delim = "\t",
                       col_names = c("chr", "pos", "nchr", "nfiltered", "nmiss", "fmiss"), skip = 1)
...
# 3. 198,897 sites of 51 males
var_miss_m <- read_delim("/Users/nuriteliash/Documents/GitHub/linkage-map/linkage-map-git/data/site_filter_malesHet.2/site_filter_malesHet.2males/malesHet.2Q20BIALLDP5mis.5Chr7males.lmiss", delim = "\t",
                       col_names = c("chr", "pos", "nchr", "nfiltered", "nmiss", "fmiss"), skip = 1)
...
```{r}
# 1. 220,219 sites of all 203 samples
var_freq <- read_delim("/Users/nuriteliash/Documents/GitHub/linkage-map/linkage-map-git/data/site_filter_malesHet.2/malesHet.2Q20BIALLDP5mis.5Chr7.frq", delim = "\t", col_names = c("chr", "pos", "nalleles", "nchr", "a1", "a2"), skip = 1)
...
# 2. 365,173 sites of 84 females
var_freq_f <- read_delim("/Users/nuriteliash/Documents/GitHub/linkage-map/linkage-map-git/data/site_filter_malesHet.2/site_filter_malesHet.2fem/malesHet.2Q20BIALLDP5mis.5Chr7Females.frq", delim = "\t", col_names = c("chr", "pos", "nalleles", "nchr", "a1", "a2"), skip = 1)
...
# 3. 198,897 sites of 51 males
var_freq_m <- read_delim("/Users/nuriteliash/Documents/GitHub/linkage-map/linkage-map-git/data/site_filter_malesHet.2/site_filter_malesHet.2males/malesHet.2Q20BIALLDP5mis.5Chr7males.frq", delim = "\t", col_names = c("chr", "pos", "nalleles", "nchr", "a1", "a2"), skip = 1)
...
# 2. 365,173 sites of 84 females
site_hwe_f <- read_delim("/Users/nuriteliash/Documents/GitHub/linkage-map/linkage-map-git/data/site_filter_malesHet.2/site_filter_malesHet.2fem/malesHet.2Q20BIALLDP5mis.5Chr7Females.hwe", delim = "\t", col_names = c("CHR","POS", "OBS(HOM1/HET/HOM2)", "E(HOM1/HET/HOM2)", "ChiSq_HWE", "P_HWE", "P_HET_DEFICIT", "P_HET_EXCESS"), skip = 1)
...
# 3. 198,897 sites of 51 males
site_hwe_m <- read_delim("/Users/nuriteliash/Documents/GitHub/linkage-map/linkage-map-git/data/site_filter_malesHet.2/site_filter_malesHet.2males/malesHet.2Q20BIALLDP5mis.5Chr7males.hwe", delim = "\t", col_names = c("CHR","POS", "OBS(HOM1/HET/HOM2)", "E(HOM1/HET/HOM2)", "ChiSq_HWE", "P_HWE", "P_HET_DEFICIT", "P_HET_EXCESS"), skip = 1)
...
write_csv(info_all_Het.2, file  = "/Users/nuriteliash/Documents/GitHub/linkage-map/linkage-map-git/data/info_all_Het.2.csv")

info_sites_Het.2_fem <- qual_f %>%
...
info_fem_male_Het.2 <- inner_join(info_sites_Het.2_fem, info_sites_Het.2_male, by = "site")

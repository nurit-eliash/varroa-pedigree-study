...
```{r}
setwd("/Users/nuriteliash/Documents/GitHub/linkage-map/linkage-map-git/data/vcftools_het")
```

### Heterozygosity and inbreeding coefficient per individual
```{r}
ind_het <- read_delim("/Users/nuriteliash/Documents/GitHub/linkage-map/linkage-map-git/data/vcftools_het/Q20BIALLDP5mis.5Chr7.het", delim = "\t",

...
```{r}
setwd("/Users/nuriteliash/Documents/GitHub/linkage-map-OneRun/VCF-oneRun/data/vcftools_het")
```

### Heterozygosity and inbreeding coefficient per individual
```{r}
ind_het <- read_delim("/Users/nuriteliash/Documents/GitHub/linkage-map-OneRun/VCF-oneRun/data/vcftools_het/Q20BIALLDP5mis.5Chr7.het", delim = "\t",
...
#### for all individuals
```{r}
site_hwe <- read_delim("/Users/nuriteliash/Documents/GitHub/linkage-map/linkage-map-git/data/vcftools_het/Q20BIALLDP5mis.5Chr7.hwe", delim = "\t", col_names = c("CHR","POS", "OBS(HOM1/HET/HOM2)", "E(HOM1/HET/HOM2)", "ChiSq_HWE", "P_HWE", "P_HET_DEFICIT", "P_HET_EXCESS"), skip = 1)
...
#### for males 
```{r}
site_hwe_males <- read_delim("/Users/nuriteliash/Documents/GitHub/linkage-map/linkage-map-git/data/vcftools_het/malesQ20BIALLDP5mis.5Chr7.hwe", delim = "\t", col_names = c("CHR","POS", "OBS(HOM1/HET/HOM2)", "E(HOM1/HET/HOM2)", "ChiSq_HWE", "P_HWE", "P_HET_DEFICIT", "P_HET_EXCESS"), skip = 1)
...
#### for females 
```{r}
site_hwe_females <- read_delim("/Users/nuriteliash/Documents/GitHub/linkage-map/linkage-map-git/data/vcftools_het/femalesQ20BIALLDP5mis.5Chr7.hwe", delim = "\t", col_names = c("CHR","POS", "OBS(HOM1/HET/HOM2)", "E(HOM1/HET/HOM2)", "ChiSq_HWE", "P_HWE", "P_HET_DEFICIT", "P_HET_EXCESS"), skip = 1)
...
are the more heterozygotic sites more abundant in males compared to females?
...
plot the sites that are almost never heterozygous in males (e.g., < 0.1) vs females
```{r}
site_het_males <- mutate(site_het_males, site = paste(site_het_males$CHR, site_het_males$POS)) 
...
but what about other info on the sites?
...
```
on the 7 chromosomes, filtering for sites of quality >20, biallelic sites, minimum depth of 5, and maximum missing of 0.5

--max-alleles 2 --minQ 20 --minDP 5 --max-missing 0.5--chr NW_019211454.1 --chr NW_019211455.1 --chr NW_019211456.1 --chr NW_019211457.1 --chr NW_019211458.1 --chr NW_019211459.1 --chr NW_019211460.1 
...
```{r}
# (1) 220,219 sites of all 203 samples 
var_qual <- read_delim("/Users/nuriteliash/Documents/GitHub/linkage-map/linkage-map-git/data/site_filter/Q20BIALLDP5mis.5Chr7.lqual", delim = "\t",col_names = c("chr", "pos", "qual"), skip = 1)
...
# (2) 365,173 sites of 84 females
var_qual_f <- read_delim("/Users/nuriteliash/Documents/GitHub/linkage-map/linkage-map-git/data/site_filter_fem/femalesQ20BIALLDP5mis.5Chr7.lqual", delim = "\t",col_names = c("chr", "pos", "qual"), skip = 1)
...
# (3) 198,897 sites of 51 males
var_qual_m <- read_delim("/Users/nuriteliash/Documents/GitHub/linkage-map/linkage-map-git/data/site_filter_male/malesQ20BIALLDP5mis.5Chr7.lqual", delim = "\t",col_names = c("chr", "pos", "qual"), skip = 1)
...
```{r}
# 1. 220,219 sites of all 203 samples
var_depth <- read_delim("/Users/nuriteliash/Documents/GitHub/linkage-map/linkage-map-git/data/site_filter/Q20BIALLDP5mis.5Chr7.ldepth.mean", delim = "\t",
...
# 2. 365,173 sites of 84 females
var_depth_f <- read_delim("/Users/nuriteliash/Documents/GitHub/linkage-map/linkage-map-git/data/site_filter_fem/femalesQ20BIALLDP5mis.5Chr7.ldepth.mean", delim = "\t",
           col_names = c("chr", "pos", "mean_depth", "var_depth"), skip = 1)
...
# 3. 198,897 sites of 51 males
var_depth_m <- read_delim("/Users/nuriteliash/Documents/GitHub/linkage-map/linkage-map-git/data/site_filter_male/malesQ20BIALLDP5mis.5Chr7.ldepth.mean", delim = "\t",
           col_names = c("chr", "pos", "mean_depth", "var_depth"), skip = 1)
...
```{r}
# 1. 220,219 sites of all 203 samples
var_miss <- read_delim("/Users/nuriteliash/Documents/GitHub/linkage-map/linkage-map-git/data/site_filter/Q20BIALLDP5mis.5Chr7.lmiss", delim = "\t",
...
# 2. 365,173 sites of 84 females
var_miss_f <- read_delim("/Users/nuriteliash/Documents/GitHub/linkage-map/linkage-map-git/data/site_filter_fem/femalesQ20BIALLDP5mis.5Chr7.lmiss", delim = "\t",
                       col_names = c("chr", "pos", "nchr", "nfiltered", "nmiss", "fmiss"), skip = 1)
...
# 3. 198,897 sites of 51 males
var_miss_m <- read_delim("/Users/nuriteliash/Documents/GitHub/linkage-map/linkage-map-git/data/site_filter_male/malesQ20BIALLDP5mis.5Chr7.lmiss", delim = "\t",
                       col_names = c("chr", "pos", "nchr", "nfiltered", "nmiss", "fmiss"), skip = 1)
...
```{r}
# 1. 220,219 sites of all 203 samples
var_freq <- read_delim("/Users/nuriteliash/Documents/GitHub/linkage-map/linkage-map-git/data/site_filter/Q20BIALLDP5mis.5Chr7.frq", delim = "\t", col_names = c("chr", "pos", "nalleles", "nchr", "a1", "a2"), skip = 1)
...
# 2. 365,173 sites of 84 females
var_freq_f <- read_delim("/Users/nuriteliash/Documents/GitHub/linkage-map/linkage-map-git/data/site_filter_fem/femalesQ20BIALLDP5mis.5Chr7.frq", delim = "\t", col_names = c("chr", "pos", "nalleles", "nchr", "a1", "a2"), skip = 1)
...
# 3. 198,897 sites of 51 males
var_freq_m <- read_delim("/Users/nuriteliash/Documents/GitHub/linkage-map/linkage-map-git/data/site_filter_male/malesQ20BIALLDP5mis.5Chr7.frq", delim = "\t", col_names = c("chr", "pos", "nalleles", "nchr", "a1", "a2"), skip = 1)
...
```{r}
# 1. 220,219 sites of all 203 samples
var_count <- read_delim("/Users/nuriteliash/Documents/GitHub/linkage-map/linkage-map-git/data/site_filter/Q20BIALLDP5mis.5Chr7.frq.count", delim = "\t", col_names = c("chr", "pos", "nalleles", "nchr", "ref (allele:count)", "alt (allele:count)"), skip = 1)
var_count <- var_count %>%
...
# 2. 365,173 sites of 84 females
var_count_f <- read_delim("/Users/nuriteliash/Documents/GitHub/linkage-map/linkage-map-git/data/site_filter_fem/femalesQ20BIALLDP5mis.5Chr7.frq.count", delim = "\t", col_names = c("chr", "pos", "nalleles", "nchr", "ref (allele:count)", "alt (allele:count)"), skip = 1)
...
# 3. 198,897 sites of 51 males
var_count_m <- read_delim("/Users/nuriteliash/Documents/GitHub/linkage-map/linkage-map-git/data/site_filter_male/malesQ20BIALLDP5mis.5Chr7.frq.count", delim = "\t", col_names = c("chr", "pos", "nalleles", "nchr", "ref (allele:count)", "alt (allele:count)"), skip = 1)
...
```{r}
# 1. 220,219 sites of all 203 samples
site_hwe <- read_delim("/Users/nuriteliash/Documents/GitHub/linkage-map/linkage-map-git/data/site_filter/Q20BIALLDP5mis.5Chr7.hwe", delim = "\t", col_names = c("CHR","POS", "OBS(HOM1/HET/HOM2)", "E(HOM1/HET/HOM2)", "ChiSq_HWE", "P_HWE", "P_HET_DEFICIT", "P_HET_EXCESS"), skip = 1)
site_hwe <- site_hwe %>%
...
# 2. 365,173 sites of 84 females
site_hwe_f <- read_delim("/Users/nuriteliash/Documents/GitHub/linkage-map/linkage-map-git/data/site_filter_fem/femalesQ20BIALLDP5mis.5Chr7.hwe", delim = "\t", col_names = c("CHR","POS", "OBS(HOM1/HET/HOM2)", "E(HOM1/HET/HOM2)", "ChiSq_HWE", "P_HWE", "P_HET_DEFICIT", "P_HET_EXCESS"), skip = 1)
...
# 3. 198,897 sites of 51 males
site_hwe_m <- read_delim("/Users/nuriteliash/Documents/GitHub/linkage-map/linkage-map-git/data/site_filter_male/malesQ20BIALLDP5mis.5Chr7.hwe", delim = "\t", col_names = c("CHR","POS", "OBS(HOM1/HET/HOM2)", "E(HOM1/HET/HOM2)", "ChiSq_HWE", "P_HWE", "P_HET_DEFICIT", "P_HET_EXCESS"), skip = 1)
...
info_all <- qual %>%
  ...
  select(site, prop_het_fem = prop_het_fem.x, prop_het_male = prop_het_male.x, qual, mean_depth, var_depth, fmiss, maf, ref_GT, ref_count, alt_GT, alt_count, hweLogPv = logp)

write_csv(info_all, path = "/Users/nuriteliash/Documents/GitHub/linkage-map/linkage-map-git/data/site_filter/info_all.csv")

info_sites_fem <- qual_f %>%
...
info_fem_male <- inner_join(info_sites_fem, info_sites_male, by = "site")

# save it as csv
write_csv(info_fem_male, path = "/Users/nuriteliash/Documents/GitHub/linkage-map/linkage-map-git/data/site_filter/info_fem_male.csv")
...
info_fem_male <- read.csv("/Users/nuriteliash/Documents/GitHub/linkage-map/linkage-map-git/data/site_filter/info_fem_male.csv")

# subset for 0.1 % of the sites and remove the columns we dont wish to plot
dat_sub1 <- info_fem_male %>%
  sample_frac(size = .01) %>%
  select(-c(site, ref_GT.x, ref_GT.y, alt_GT.x, alt_GT.y))

dat_sub5 <- info_fem_male %>%
  sample_frac(size = .05) %>%
  select(-c(site, ref_GT.x, ref_GT.y, alt_GT.x, alt_GT.y))

dat_sub10 <- info_fem_male %>%
  sample_frac(size = .1) %>%
  select(-c(site, ref_GT.x, ref_GT.y, alt_GT.x, alt_GT.y))
...
```{r}
ped <- read_csv("/Users/nuriteliash/Documents/GitHub/varroa-linkage-map/data/pedigree_info_223.csv") %>%
  na.omit() 
data.table::uniqueN(ped$family)
...
---
  #didnt use :
  pivot_longer(cols = c("hom1", "het", "hom2"), names_to = "zyg", values_to = "count") %>%

# compare the sites (x = females, y = males) for high prop >0.9
het.9_males <- site_het_males %>%
  filter(prop_het >0.9)

comp_sites.9 <- full_join(site_het_females, het.9_males, by = "site")
comp_sites.9 <- na.omit(comp_sites)

ggplot(comp_sites, aes(prop_het.x)) + geom_histogram(fill="#69b3a2", color="#e9ecef", alpha=0.8) + 
  theme_light() +
  ggtitle("Heterozygosity per site > 0.9 - MALES")+
  xlab("Proportion of het genotype") + 
